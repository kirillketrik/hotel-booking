...
from apps.users.selectors import user_get_by_pk, user_get_queryset
from apps.users.serializers import LoginUserSerializer, RegisterUserSerializer, UserSerializer
...
class UsersViewSet(
    ...
    def refresh(self, request, *args, **kwargs):
        ...
        try:
            ...
            try:
                user = user_get_by_pk(pk=refresh["user_id"])
